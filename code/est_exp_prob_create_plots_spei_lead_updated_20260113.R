...
# create variables for Pb levels indicating exposure, and clinical toxicity (See Paine and Green 2015 and refs therein;and Franson and Pain (2011) Table 16.1 a)
...
recent_fws_20182025 <- read.csv("data/eider_lead_fws_2018-2025_20251203.csv", header = TRUE)
str(recent_fws_20182025)

# cbind relevant columns
data_fws <- cbind.data.frame(recent_fws_20182025$id_metalBand,
                recent_fws_20182025$id_species,
                recent_fws_20182025$dt_sampled,
                recent_fws_20182025$id_studySite,
                recent_fws_20182025$cat_periodCapt,
                recent_fws_20182025$cat_age,
                recent_fws_20182025$cat_sex,
                recent_fws_20182025$pb_blood_ppm)
# rename columns
